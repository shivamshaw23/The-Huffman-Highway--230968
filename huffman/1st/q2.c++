// I dont know how to solve this question. how to solve as for addition it takes two input but as for sin it only requires one input 
// if i want to add at 1st step i require two input. but if i add at later step it only requires one input 
